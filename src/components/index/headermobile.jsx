  ...
  return (
    ...
    >
      ...
      <Flex style={{ width: '100%', height: '100%' }} gap="large" justify="space-between" align="center">
        ...
        <a onClick={imgClick} style={{ display: 'flex', alignItems: 'center' }} href="/"><img style={{ height: '15px' }} aria-labelledby="logo" src={logo} /></a>
      ...
      <Flex justify="center" align="center" style={{ height: '100%' }}>
        ...
        <AutoComplete
          ...
          options={options}
          onChange={onChange}
          popupClassName={styles.searchpopupMobile}
          notFoundContent={
            <div
              className={styles.noneStyleMobile}
            >
              <FileUnknownOutlined
...
export default CPOHeaderMobile;
